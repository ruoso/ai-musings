...
module.exports = function(config) {
    ...
    var hunger = 0;
    var direction = "E"; // start heading east;
    ...
    var is_moving = 0;
    var is_dead = 0;
    this.is_dead = function() { return is_dead; };
	...
	inputs.digestion.hunger[0].message();
	inputs.digestion.hunger[1].message();
	inputs.digestion.hunger[2].message();
	inputs.digestion.hunger[3].message();
    };
    ts.push(setInterval(function() {
	if (hunger > 5) {
	    hunger_message();
